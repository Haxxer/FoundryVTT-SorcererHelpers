...
// ATTENTION!
// You must change `base` and the `proxy` strings replacing `/modules/sorcererhelpers/` with your
// module or system ID.
...
export default () => {
  ...
  return {
    ...
    base: '/modules/sorcererhelpers/',   // Base module path that 30001 / served dev directory.
    ...
    server: {
      ...
      open: false,
      proxy: {
        '^(/modules/sorcererhelpers/languages)': 'http://127.0.0.1:30000',
        '^(?!/modules/sorcererhelpers/)': 'http://127.0.0.1:30000',
